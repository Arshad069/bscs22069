...
document.getElementById("hero-text").innerHTML = `
    <h1 style="font-size=1.5rem">${portfolioData.hero.title}</h1>
...
// document.getElementById("project-video").src = "PaintApp.mp4"; // Set video source
// document.getElementById("project-video").load(); // Load the new source
